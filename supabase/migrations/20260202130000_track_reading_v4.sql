...
-- Fix ambiguous column reference by creating a new version of the function
-- This bypasses the need to DROP the old function which was causing conflicts.

CREATE OR REPLACE FUNCTION track_reading_time_v4(seconds int, p_book_id uuid)
RETURNS void
LANGUAGE plpgsql
SECURITY DEFINER
AS $$
